...
tar xvzf "${WORK_DIR}/$IID.tar.gz" -C "${IMAGE_DIR}"
...
cp "scripts/inferFile.sh" "${IMAGE_DIR}"
...
cp "scripts/fixImage.sh" "${IMAGE_DIR}"
...
cp "scripts/preInit.sh" "${IMAGE_DIR}/firmadyne/preInit.sh"
chmod a+x "${IMAGE_DIR}/firmadyne/preInit.sh"

cp "scripts/network.sh" "${IMAGE_DIR}/firmadyne/network.sh"
chmod a+x "${IMAGE_DIR}/firmadyne/network.sh"

cp "scripts/run_service.sh" "${IMAGE_DIR}/firmadyne/run_service.sh"
chmod a+x "${IMAGE_DIR}/firmadyne/run_service.sh"

cp "scripts/injectionChecker.sh" "${IMAGE_DIR}/bin/a"
